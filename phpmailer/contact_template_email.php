...
try {
    ...
    $mail->setFrom('s.danish0827@gmail.com', 'Message from Paradise Hotel');             // Email Address and Name FROM
    $mail->addAddress('s.danish0827@gmail.com', 'Jhon Doe');                            // Email Address and Name TO - Name is optional
    $mail->addReplyTo('s.danish0827@gmail.com', 'Message from Paradise Hotel');       // Email Address and Name NOREPLY
    $mail->isHTML(true);
